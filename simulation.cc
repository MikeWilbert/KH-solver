                              ...
                              int dir )
{
  ...
  for( size_t iy = 0; iy < end[1]; iy++ ){
    ...
    double beta_1 = 13./12. * sqr( prim_l3 - 2.*prim_l2 + prim_l1, 2 ) + 1./4. * pow(    prim_l3 - 4.*prim_l2 + 3.*prim_l1 );
    double beta_2 = 13./12. * sqr( prim_l2 - 2.*prim_l1 + prim_r1, 2 ) + 1./4. * pow(    prim_l2              -    prim_r1 );
    double beta_3 = 13./12. * sqr( prim_l1 - 2.*prim_r1 + prim_r2, 2 ) + 1./4. * pow( 3.*prim_l1 - 4.*prim_r1 +    prim_r2 );
  ...
  for( size_t iy = 0; iy < end[1]; iy++ ){
    ...
    double beta_1 = 13./12. * sqr( prim_r3 - 2.*prim_r2 + prim_r1, 2 ) + 1./4. * pow(    prim_r3 - 4.*prim_r2 + 3.*prim_r1 );
    double beta_2 = 13./12. * sqr( prim_r2 - 2.*prim_r1 + prim_l1, 2 ) + 1./4. * pow(    prim_r2              -    prim_l1 );
    double beta_3 = 13./12. * sqr( prim_r1 - 2.*prim_l1 + prim_l2, 2 ) + 1./4. * pow( 3.*prim_r1 - 4.*prim_l1 +    prim_l2 );
